...
class TTailCutsDataVolumeReducer(DataVolumeReducer):
    ...
    cleaner_type = TelescopeParameter(
        trait=ComponentName(TailcutsImageCleaner, default_value="TimeConstrainedImageCleaner"),
        default_value="TimeConstrainedImageCleaner",
        help="Name of the ImageExtractor subclass to be used.",
    ).tag(config=True)
    ...
    def select_pixels(self, waveforms, tel_id=None, selected_gain_channel=None):
        ...
        # 1) Step: TailcutCleaning at first
        cleaner = self.cleaner_type.tel[tel_id]
