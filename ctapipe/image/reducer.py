...
from ctapipe.image.cleaning import ClusteringImageCleaner, TailcutsImageCleaner, dilate
...
class ClusteringDataVolumeReducer(DataVolumeReducer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if cleaner is None:
            self.cleaner = ClusteringImageCleaner(parent=self, subarray=self.subarray)
        else:
            self.cleaner = cleaner
